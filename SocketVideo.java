...
public class Server {
	...
	public static void main(String[] args)
	{
		...
		try (ServerSocket serverSocket
			= new ServerSocket(6002)) {
			System.out.println(
				"Server is Starting in Port 6002");
...
public class Client {
    ...
    public static void main(String[] args)
    {
        ...
        try (Socket socket = new Socket("10.10.10.46", 6002)) {
          ...
          sendFile(
                "/home/pict/Downloads/5 Second Video_ Watch the Milky Way Rise.mp4");
